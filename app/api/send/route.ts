...
export async function POST(req: Request) {
    ...
    try {
                                                    ...
                                                    <tr>
                                                        <td style="text-align: right">
                                                            <img src="https://cxqkuqtwrtgvoorxidvn.supabase.co/storage/v1/object/public/assets/logo%201.png"
                                                                alt="Dentalbio Logo" width="150" style="
                                                        display: block;
                                                        border: 0;
                                                        height: auto;
                                                        line-height: 100%;
        ...
        console.log('inviteusername================', inviteUserName, 'inviteUserName-----------')
        ...
        //     console.log('testdata------------------', inviteUserEmail, 'inviteUserEmail---------------------------')
        ...
        //     //                                             <br /><br />
        //     //                                             Your referral is now part of the <b>Dentalbio</b> community, and you both get to enjoy
        //     //                                             the benefits of creating your personal dental identity.
        //     //                                         </p>

        //     //                                         <!-- Pro Plan Feature -->
        //     //                                         <p
        //     //                                             style="font-size: 16px; font-weight: 400; color: #1c1c21; line-height: 1.7; margin-top: 30px;">
        //     //                                             🎁 <b>Special Offer</b>: Your referral also receives 1 month of Pro Plan features for
        //     //                                             free! You're both getting the most out of your Dentalbio experience. 😎
        //     //                                         </p>

        //     //                                         <p
        //     //                                             style="font-size: 16px; font-weight: 400; color: #1c1c21; line-height: 1.7; margin: 20px 0; margin-top: 30px;">
        //     //                                             Thanks for sharing Dentalbio, and we can't wait to see the amazing dental journeys you
        //     //                                             and your invitees will build together!
        //     //                                         </p>
        //     //                                     </td>
        //     //                                 </tr>
        //     //                                 <!-- Footer -->
