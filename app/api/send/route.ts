...
//   const { email, firstName, username, time, location }: EmailData = await req.json();
...
//           <title>You have secured your Dentalbio username</title>
//         </head>
...
//                       </p>
//                       <p style="color: #1c1c21; font-size: 12px; margin-top: 30px; line-height: 1.7;">
//                         Registration time: ${time}
//                       </p>
//                       <p style="color: #1c1c21; font-size: 12px; margin-top: 14px; line-height: 1.7;">
//                         Location: ${location}
//                       </p>
//                       <p style="font-size: 16px; font-weight: 400; color: #1c1c21; line-height: 1.7; margin: 20px 0; margin-top: 30px;">
//                         We will let you know when we launch so you can log in and start customizing your Dentalbio!
//                       </p>
//                     </td>
//                   </tr>
//                   <!-- Footer -->
...
export async function POST(req: Request) {
  ...
  try {
    ...
    const adminEmail = await resend.emails.send({
      from: "Dentalbio <noreply@dental.bio>",
      to: ["shaz@dental.bio", "huba.ferencz.personal@gmail.com"], // Multiple recipients
