  ...
  return (
    ...
    >
      <span className="bg-gradient-to-r from-[#8866e9] via-[#cb7470] to-[#ed8b39] bg-clip-text text-transparent">
        <span className="text-2xl -mb-5 lg:text-[26px] font-bold  max-w-screen-md w-full mx-auto bg-gradient-to-r from-[#8866e9] via-[#cb7470] to-[#ed8b39] bg-clip-text text-transparent">
          You did it!
        </span>
        ...
        <span className="text-[26px] font-bold  max-w-screen-md w-full mx-auto from-primary-1 via-primary-2 to-primary-orange-1 bg-clip-text text-transparent">
          is <span className=" border-b-4 border-[#8866e9] ">almost</span>{" "}
          yours!
        </span>
      </span>

      <span className="text-2xl -mb-5 -mt-5 lg:text-[26px] font-bold  max-w-screen-md w-full mx-auto bg-gradient-to-r from-[#8866e9] via-[#cb7470] to-[#ed8b39] bg-clip-text text-transparent">
