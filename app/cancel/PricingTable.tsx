...
const PricingTable: React.FC<PricingTableProps> = ({ email }) => {
  ...
  return (
    <div className="relative w-full">
      <div className="flex justify-between items-center mb-10 md:mb-20 mt-10 px-1 md:px-5">
        <h2 className="text-2xl md:text-5xl font-medium text-center z-10">
          Pricing
        </h2>
            ...
            if (plan.isFree) {
              ...
              return (
                <motion.div
                  ...
                  className={`relative border border-neutral-200 md:border-white shadow-xl md:shadow-sm h-min bg-white z-10 rounded-xl p-8 ${
                    plan.mostPopular ? "" : " "
                  }`}
                >
                  {plan.mostPopular && (
                  ...
                  <div className="mt-6">
                    <span className="flex justify-between items-center w-full text-center bg-green-600 text-white py-3 px-5 rounded-full font-semibold">
                      Current plan
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
              ...
              return (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -20 }}
                  transition={{ duration: 0.2 }}
                  className={`relative border border-neutral-200 md:border-white shadow-xl md:shadow-sm z-10 h-min bg-white rounded-xl p-8 ${
                    plan.mostPopular ? "" : " "
                  }`}
                >
                  {plan.mostPopular && (
                  ...
                  <div className="mt-6">
                    <button
                      ...
                      className="flex justify-between items-center w-full text-center bg-gradient-to-r from-[#e7b274] to-[#d46466] text-white py-3 px-5 rounded-full font-semibold hover:opacity-90 transition"
                    >
                      {plan.cta}
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
