...
//   return (
//     <ParallaxProvider>
//       <div className="bg-transparent relative md:max-h-screen h-full flex items-center justify-center w-full mt-14 lg:mt-32">
//         {/* Wrapper for the columns */}
//         <div className="bg-transparent relative flex justify-center w-full mx-auto md:gap-7 overflow-clip  md:pb-40">
//           {/* First Column - Flip from the Left + Hover */}
//           <motion.div
//             className="bg-transparent hidden md:flex items-center w-[350px] "
...
//           <motion.div
//             className="bg-transparent hidden md:flex items-center w-[350px] pt-20 -mr-6"
//             variants={flipVariantsLeft}
//             initial="hidden"
//             animate="visible"
//             onMouseMove={(e) => handleMouseMove(e, e.currentTarget)}
...
//           <div
//             className="bg-transparent relative md:hidden flex items-center z-[9999]  justify-center mx-auto px-5 md:px-10 w-full md:w-96 lg:w-[500px]"
...
//           </div>
//           <motion.div
//             className="bg-transparent hidden relative md:flex z-[9999]  items-center justify-center mx-auto px-5 w-full md:w-96 lg:w-[500px]"
...
//           <motion.div
//             className="bg-transparent hidden md:flex items-center w-[350px] pt-10 -ml-6"
...
//             <motion.div
//               className="bg-transparent hidden md:flex flex-col justify-end gap-10 items-start w-[350px] pt-40"
//               variants={flipVariantsRight}
//               initial="hidden"
//               animate="visible"
//               onMouseMove={(e) => handleMouseMove(e, e.currentTarget)}
